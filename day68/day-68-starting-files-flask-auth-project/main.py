...
# CREATE TABLE IN DB (added Mixin for login purpose-Part of step A)
...
def register():
    ...
    if request.method =="POST":
        with app.app_context():
            ...
            login_user(new_user)   # STEP B

            return render_template('secrets.html', username=request.form.get("name").title())
    return render_template("register.html",logged_in=current_user.is_authenticated)


# STEP C (create my login page)
