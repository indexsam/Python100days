...
# https://forms.gle/z3Pnc3S6kbbgygun7
...
#==============get user email===========
user_email_data = data_manager.get_customer_emails()
...
for destination in sheet_data:
    ...
    if cheapest_flight.price != "N/A" and cheapest_flight.price < destination["lowestPrice"]:
        ...
        for dict_val in user_email_data:
            email = dict_val["whatIsYourEmail?"]
            notification_manager.send_email(msg, email)
